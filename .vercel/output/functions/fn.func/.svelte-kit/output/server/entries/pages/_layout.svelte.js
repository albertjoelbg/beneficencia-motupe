...
const LogoYoutube = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let labelled;
  let attributes;
  let $$restProps = compute_rest_props($$props, ["size", "title"]);
  let { size = 16 } = $$props;
  ...
  return `<svg${spread(
    ...
    {}
  )}>${title ? `<title>${escape(title)}</title>` : ``}<path d="M29.41,9.26a3.5,3.5,0,0,0-2.47-2.47C24.76,6.2,16,6.2,16,6.2s-8.76,0-10.94.59A3.5,3.5,0,0,0,2.59,9.26,36.13,36.13,0,0,0,2,16a36.13,36.13,0,0,0,.59,6.74,3.5,3.5,0,0,0,2.47,2.47C7.24,25.8,16,25.8,16,25.8s8.76,0,10.94-.59a3.5,3.5,0,0,0,2.47-2.47A36.13,36.13,0,0,0,30,16,36.13,36.13,0,0,0,29.41,9.26ZM13.2,20.2V11.8L20.47,16Z"></path></svg>`;
});
function quintOut(t) {
  return --t * t * t * t * t + 1;
}
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render($$result, { rounded: true, class: "bg-primary-100" }, {}, {
    ...
    default: () => {
      return `<div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4"><div><h2 class="mb-6 text-sm font-semibold text-gray-400 uppercase" data-svelte-h="svelte-gv75ks">Institucionalidad</h2> ${validate_component(FooterLinkGroup, "FooterLinkGroup").$$render($$result, { ulClass: "text-gray-300" }, {}, {
        default: () => {
          return `${validate_component(FooterLink, "FooterLink").$$render($$result, { liClass: "mb-4", href: "/" }, {}, {
            default: () => {
              return `Portal de Transparencia`;
            }
      ...
      })}</div> <div><h2 class="mb-6 text-sm font-semibold uppercase text-gray-400" data-svelte-h="svelte-8r3tce">Redes Sociales</h2> ${validate_component(FooterLinkGroup, "FooterLinkGroup").$$render($$result, { ulClass: "text-gray-300" }, {}, {
        default: () => {
          return `${validate_component(FooterLink, "FooterLink").$$render($$result, { liClass: "mb-4", href: "/" }, {}, {
            default: () => {
              return `Youtube`;
      ...
      })}</div> <div><h2 class="mb-6 text-sm font-semibold uppercase text-gray-400" data-svelte-h="svelte-4gt2m3">Contacto</h2> ${validate_component(FooterLinkGroup, "FooterLinkGroup").$$render($$result, { ulClass: "text-gray-300" }, {}, {
        default: () => {
          return `${validate_component(FooterLink, "FooterLink").$$render($$result, { liClass: "mb-4", href: "/" }, {}, {
            default: () => {
      ...
      })}</div> <div><h2 class="mb-6 text-sm font-semibold uppercase text-gray-400" data-svelte-h="svelte-bwrutr">Novedades</h2> ${validate_component(FooterLinkGroup, "FooterLinkGroup").$$render($$result, { ulClass: "text-gray-300" }, {}, {
        default: () => {
          return `${validate_component(FooterLink, "FooterLink").$$render($$result, { liClass: "mb-4", href: "/" }, {}, {
            default: () => {
              return `Eventos`;
            ...
            default: () => {
              return `Incentivo Cultural`;
            }
          })}`;
        }
      })}</div></div> <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">${validate_component(FooterCopyright, "FooterCopyright").$$render(
        $$result,
        {
        ...
        {},
        {}
      )} <div class="flex mt-4 space-x-6 rtl:space-x-reverse sm:justify-center md:mt-0">${validate_component(FooterIcon, "FooterIcon").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `${validate_component(LogoFacebook, "LogoFacebook").$$render(
            $$result,
            {
        ...
        default: () => {
          return `${validate_component(LogoTwitter, "LogoTwitter").$$render(
            $$result,
            {
              class: "w-4 h-4 text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white"
            },
        ...
        default: () => {
          return `${validate_component(LogoYoutube, "LogoYoutube").$$render(
            $$result,
            {
              class: "w-4 h-4 text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white"
            },
